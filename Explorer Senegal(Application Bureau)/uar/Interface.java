...
public class Interface extends JFrame implements ActionListener {
	...
	public Interface()
	{
		super("Visiter Le SENEGAL(Mon petit pays ensoleill� d'Afrique de l'ouest) | Explorer SENEGAL(My little sunny countries in West Africa)");
		setExtendedState(JFrame.MAXIMIZED_BOTH);; //On donne une taille � notre fen�tre
		setLocationRelativeTo(null); //On centre la fen�tre sur l'�cran
		setLayout(new FlowLayout());
		//Charge le liens donn�e par note application ext�rieur au projet, fournit comme un service
		chargeDonnee("http://localhost:8084/WebApplication//index.jsp");
		
		//Initialisation de nos �l�ments graphique
